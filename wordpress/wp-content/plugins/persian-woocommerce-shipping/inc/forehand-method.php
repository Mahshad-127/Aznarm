...
class WC_Forehand_Method extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_description = __( 'ارسال کالا با استفاده از پست پیشتاز' ) . PWS()->donate();
	...
	public function init() {
		...
		$this->insurance_cost      = $this->get_option( 'insurance_cost', 8000 );
	...
	public function calculate_shipping( $package = array() ) {
		...
		$rate_price['500']['in']     = 55000;
		$rate_price['500']['beside'] = 75000;
		$rate_price['500']['out']    = 95000;

		$rate_price['1000']['in']     = 70000;
		$rate_price['1000']['beside'] = 100000;
		$rate_price['1000']['out']    = 110000;
		...
		$checked_state = PWS()->check_states_beside( $this->source_state, $this->destination_state );
		...
		if ( $weight_indicator != '9999' ) {
			...
			$shipping_total = $rate_price['1000'][ $checked_state ] + ( $rate_price[ $weight_indicator ] * ceil( ( $weight - 1000 ) / 1000 ) );
		}
